...
def main():
    ...
    for f in ["utt2num_samples", "text", "wav.scp", "utt2spk"]:
    ...
    assert len(content_utt2num_samples) == len(content_text) and len(content_text) == len(content_wav_scp) and len(content_wav_scp) == len(content_utt2spk)
