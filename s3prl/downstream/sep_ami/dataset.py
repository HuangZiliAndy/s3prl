...
if __name__ == '__main__':
    data_dir = "/export/c02/hzili1/datasets/s3prl_csp/downstream/sep_ami/2spk_reverb_diffuse/dev"
    rate = 16000
    src_cond = 'wav'
    tgt_conds = 's1,s2'
    channel = "0,5,7"
    ...
    ##    src_audios, tgt_audios, src_stft_mag, tgt_stft_mag, src_stft_phase, tgt_stft_phase, uttname_list = v
    ##    print('-' * 80)
    ##    print("src_audios", src_audios.size())
    ##    print("tgt_audios", tgt_audios.size())
    ##    print("src_stft_mag", src_stft_mag.size())
    ##    print("tgt_stft_mag", tgt_stft_mag.size())
    ##    print("src_stft_phase", src_stft_phase.size())
    ##    print("tgt_stft_phase", tgt_stft_phase.size())
    ##    print("uttname_list", uttname_list)
    ##    if i == 1:
    ##        break
