...
class DownstreamExpert(nn.Module):
    ...
    def log_records(
        ...
        logger.add_scalar(
            f"diar_alimeeting/{mode}-loss", average_loss, global_step=global_step
        )
        logger.add_scalar(
            f"diar_alimeeting/{mode}-acc", average_acc, global_step=global_step
        )
        logger.add_scalar(
            f"diar_alimeeting/{mode}-der", average_der, global_step=global_step
        )
