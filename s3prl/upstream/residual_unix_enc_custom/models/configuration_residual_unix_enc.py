...
class ResidualUnixEncConfig(PretrainedConfig):
    def __init__(
        self, 
        ...
        **kwargs
        ...
        self.allchan_encoder_layers = allchan_encoder_layers
        ...
        self.mask_after_sum = mask_after_sum
